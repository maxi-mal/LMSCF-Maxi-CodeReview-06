		...
		return `<div class="col-lg-4 col-md-6 mb-4">
	                <div class="card h-100">
	                    ...
	                    <div class="card-body">
	                        ...
	                        <hr>
	                        <p class="card-text"><i class="colorIcon fas fa-map-marked-alt"></i> ${this.address}</p>
	                        <p class="card-text">${this.city}, ${this.zip}</p>
							<p class="card-text"><i class="colorIcon fas fa-phone-square-alt"></i> ${this.phone}</p>
							<p class="card-text"><span class="glyphicon glyphicon-ok-sign" style="color:#DDDDDD;"></span> ${this.yard}</p>
	                    </div>
		...
		return `<div class="col-lg-4 col-md-6 mb-4">
	                <div class="card h-100">
	                    ...
	                    <div class="card-body">
	                        ...
	                        <h5 class="fontCardTitle d-flex justify-content-start">${this.cuisine}</h5>
	                        <hr>
	                        <p class="card-text"><i class="colorIcon fas fa-map-marked-alt" aria-hidden="true"></i> ${this.address}, ${this.city}, ${this.zip}</p>
							<p class="card-text"><i class="colorIcon fas fa-phone-square-alt" aria-hidden="true"></i> ${this.phone}</p>
							<p class="card-text"><i class="fa fa-calendar" aria-hidden="true"></i> ${this.day}</p>
							<p class="card-text"><span class="glyphicon glyphicon-time" aria-hidden="true"></span> ${this.time}</p>
	                    </div>
	                    <div class="card-footer">
	                        <small class="text-muted">${this.created}</small>
	                    </div>
